...
package provide bis_ipsicontrahistogram 1.0
package require bis_dualimagealgorithm 1.0


itcl::class bis_ipsicontrahistogram {
    ...
    public method GetGUIName    { } { return "CUDA Intrinsic Ipsicontra Map" }
...
itcl::body bis_ipsicontrahistogram::Initialize { } {

    PrintDebug "bis_ipsicontrahistogram::Initialize" 
    ...
    set scriptname bis_ipsicontrahistogram
    ...
    set description "Calculate the histogram ipsicontra of an image."
...
itcl::body bis_ipsicontrahistogram::Execute {  } {
	...
	if { $::pxtclvtkpxcontrib::usescuda == 0 } {
	    ...
	    set map  [ vtkbisIpsiContraHistogram New  ] 
	} else {
	    set map  [ vtkbisCUDAIntrinsicCorrelation New  ] 
	    $map SetUseGPU 1
	    $map SetDoIpsiAndContra 1
	}
    } else {
	set map  [ vtkbisIpsiContraHistogram New  ] 
    }
    ...
    $this SetFilterCallbacks $map "Calculate intrinsic ipsicontra histogram"
    $map Update
...
itcl::body bis_ipsicontrahistogram::CheckInputObjects { } {
...
itcl::body bis_ipsicontrahistogram::UpdateOutputFilenames { } {
    ...
    if { $gpu ==1 } {
	set defaultsuffix [ list  "_GPU_ipsicontra_hist" ]
    } else { 
	set defaultsuffix [ list  "_CPU_ipsicontra_hist" ]
    }
...
if { [ file rootname $argv0 ] == [ file rootname [ info script ] ] } {
    ...
    set alg [ bis_ipsicontrahistogram [ pxvtable::vnewobj ] ]
    $alg MainFunction 
}
