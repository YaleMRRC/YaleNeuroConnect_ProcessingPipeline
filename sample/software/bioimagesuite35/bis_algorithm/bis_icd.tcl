...
package require bis_connectivityhistogram 1.0
...
itcl::class bis_icd {
    ...
    public method GetGUIName    { } { return "ICD" }
...
itcl::body bis_icd::Execute {  } {
    
    #some of these don't get used yet!!!!
    set usegpu       [ $OptionsArray(usegpu)     GetValue ]
    set range        [ $OptionsArray(range) GetValue ]
    set msk          [ $OptionsArray(usemask) GetValue ] ; #not used 

    set image_in     [ $this GetInput ]
    set allrunsimage $image_in
    set mask  [ $this GetInputObject second_image ] 

    set con [ bis_connectivityhistogram \#auto ]
	...
	$crop SetOptionValue stopt 100
    } else { 
	$crop SetOptionValue startt 102
	$crop SetOptionValue stopt 201
    }
    ...
    set norm [ bis_normalizeicd \#auto ]
    $norm InitializeFromContainer 0 $this
    $norm SetInput [ $crop2 GetOutput ]
    $norm SetSecondInput $mask
    $norm Execute
    [ $norm GetOutput ] Save ${tmpname}_Alpha_norm.nii.gz

    set outimage [ $OutputsArray(output_image) GetObject ]
    $outimage ShallowCopyImage [ [ $icd GetOutput ] GetObject ]
    $outimage CopyImageHeader [ $image_in GetImageHeader ]
 
    itcl::delete obj $survival
    itcl::delete obj $norm
    itcl::delete obj $icd
...
itcl::body bis_icd::UpdateOutputFilenames { } {
    
    set defaultsuffix [ list  "_ICD" ]
...
if { [ file rootname $argv0 ] == [ file rootname [ info script ] ] } {
    ...
    set alg [bis_icd [ pxvtable::vnewobj ] ]
    $alg MainFunction 
}
